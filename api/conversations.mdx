---
title: "Wacrm Conversations API: List Threads and Messages"
sidebarTitle: "Conversations"
description: "List and read conversations with GET /api/v1/conversations. Fetch message history with /conversations/{id}/messages. Requires conversations:read scope."
---
...
<ResponseField name="data" type="Conversation[]">
  ...
  <Expandable title="Conversation object fields">
    ...
    <ResponseField name="contact_id" type="string">UUID of the contact associated with this conversation.</ResponseField>
    <ResponseField name="status" type="string">Current status: `open`, `pending`, or `closed`.</ResponseField>
    <ResponseField name="assigned_agent_id" type="string | null">UUID of the assigned agent, or `null` if unassigned.</ResponseField>
    <ResponseField name="last_message_text" type="string | null">Text preview of the most recent message, or `null` if no messages yet.</ResponseField>
    <ResponseField name="last_message_at" type="string | null">ISO 8601 timestamp of the most recent message, or `null`.</ResponseField>
    <ResponseField name="unread_count" type="number">Number of unread messages in this conversation.</ResponseField>
...
<ResponseField name="interactive_reply_id" type="string | null">

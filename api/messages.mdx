---
title: "Wacrm Messages API: Send WhatsApp Messages via REST"
sidebarTitle: "Messages"
description: "Send text, template, and media WhatsApp messages from your scripts using POST /api/v1/messages. Requires the messages:send API key scope."
---
